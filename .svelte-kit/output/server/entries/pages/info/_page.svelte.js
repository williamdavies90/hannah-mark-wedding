...
const css = {
  code: ".info-container.svelte-7261q6{display:grid;gap:15px;padding:0px}.gold.svelte-7261q6{font-family:'Dancing Script', cursive;color:var(--accent-color2);font-size:20px !important}.guest-text.svelte-7261q6{font-size:13px !important}ul.svelte-7261q6{padding-top:10px;padding-left:15px}.title-container h3 span{margin-right:20px;margin-top:5px;display:block;height:21px;width:30px;float:left}",
  map: null
};
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
  return `${$$result.head += `<!-- HEAD_svelte-1fsrt27_START -->${$$result.title = `<title>Helpful Information</title>`, ""}<meta name="description" content="General Information"><!-- HEAD_svelte-1fsrt27_END -->`, ""} <div data-svelte-h="svelte-81u84u"><div class="embed-responsive embed-responsive-16by9"><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2422.6983434894128!2d-2.7819027230580216!3d52.61122322947126!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x487074ebd441d101%3A0xce6dad305fd3001a!2sNetley%20Hall%20Weddings!5e0!3m2!1sen!2suk!4v1722867771973!5m2!1sen!2suk"></iframe></div></div> <div style="margin-top: 20px; margin-bottom: 100px;" class="container"><div class="info-container svelte-7261q6"><div class="row" data-svelte-h="svelte-qz2ogl"><div class="col-6"><h3 class="mb-0 text-center">Day Guests</h3> <p class="mb-0 text-center guest-text svelte-7261q6">Ceremony at 1pm,<br>guests to arrive from 12.30pm</p></div> <div class="col-6"><h3 class="mb-0 text-center">Evening Guests</h3> <p class="mb-0 text-center guest-text svelte-7261q6">Guests to arrive<br>from 7pm</p></div></div> <p class="mb-3 text-center gold svelte-7261q6" data-svelte-h="svelte-1mqj2qh">Bar open until 12.30am, DJ playing until 1am.</p> ${validate_component(InfoCard, "InfoCard").$$render($$result, { title: "<span>🏩</span> Wedding Venue" }, {}, {
    default: () => {
